...
return [
    ...
    'auth' => [
        ...
        'email_verification' => [
            ...
            'logout_btn' => 'Изход',
                'math_captcha_label' => 'За да потвърдите, че сте човек, решете: :num1 + :num2 = ?',
        'math_captcha_error' => 'Неправилен отговор на математическата проверка.',
],
        'password_reset' => [
        ...
        'for_guide' => 'За статия:',
        'global_placeholder' => 'Опишете предложението си подробно...',
        'global_title' => 'Предложения на общността | DevSense',
...
'reports' => [
    ...
    'vip' => [
        'restricted_title' => '🔒 Ограничена статия',
        'restricted_desc' => 'Това ръководство по киберсигурност съдържа чувствителна техническа информация и е ограничено само за VIP потребители. Ако имате акаунт, моля, свържете се с администратора, за да заявите VIP достъп.',
        'login_btn' => 'Влезте за достъп',
        'pending_badge' => 'Очаква одобрение за достъп',
            'request_btn' => 'Заявка за VIP достъп',
        'request_success' => 'Вашата заявка за VIP достъп беше изпратена успешно.',
    ],
    'article' => [
        'anonymous_author' => 'Анонимен автор',
        'author_label' => 'Автор',
        'published_label' => 'Публикувано',
    ],
];