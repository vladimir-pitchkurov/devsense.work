...
return [
    ...
    'architecture_index' => [
        ...
        'description' => 'Системен дизайн под натоварване: приемане на събития, буфериране, брокери, производителност на БД, пулове връзки за PHP, индекси, мащабиране, разделяне на OLTP и аналитика.',
