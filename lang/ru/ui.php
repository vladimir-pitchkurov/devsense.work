...
return [
    ...
    'architecture_index' => [
        ...
        'description' => 'Системный дизайн под нагрузку: приём событий, буферизация, брокеры, производительность БД, пулы соединений для PHP, индексы, масштабирование, разделение OLTP и аналитики.',
