...
return [
    ...
    'auth' => [
        ...
        'email_verification' => [
            ...
            'logout_btn' => 'Выйти',
                'math_captcha_label' => 'Чтобы подтвердить, что вы человек, решите: :num1 + :num2 = ?',
        'math_captcha_error' => 'Неверный ответ на проверочный пример.',
],
        'password_reset' => [
        ...
        'global_placeholder' => 'Опишите ваше предложение подробно (минимум 10 символов)...',
        'global_title' => 'Предложения сообщества | DevSense',
...
'reports' => [
    ...
    'dashboard' => [
        ...
        'xp_info_tooltip' => 'Зарабатывайте XP, проходя квизы и курсы. Каждые 100 XP увеличивают силу вашего голоса в дорожной карте на +1.',],
    'quizzes' => [
    ...
    'vip' => [
        'restricted_title' => '🔒 Закрытая статья',
        'restricted_desc' => 'Это руководство по кибербезопасности содержит конфиденциальную техническую информацию и доступно только для VIP-пользователей. Если у вас есть аккаунт, пожалуйста, свяжитесь с администратором для получения VIP-доступа.',
        'login_btn' => 'Войти для доступа',
        'pending_badge' => 'Ожидает одобрения доступа',
            'request_btn' => 'Подать заявку на VIP-доступ',
        'request_success' => 'Ваша заявка на получение VIP-доступа была успешно отправлена.',
    ],
    'article' => [
