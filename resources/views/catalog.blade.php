                    ...
                    @if(!request()->route('category_slug'))
                        <div class="search-group">
                            ...
                            <div class="search-options">
                                <a href="{{ route('search', array_filter(request()->except('category', 'page'))) }}" class="search-option {{ !$selectedCategory ? 'active' : '' }}">
                                ...
                                @foreach($categories as $cat)
                                    ...
                                    @endphp
                                    <a href="{{ route('search', array_merge(request()->except('page'), ['category' => $cat->slug])) }}" class="search-option {{ $selectedCategory && $selectedCategory->id === $cat->id ? 'active' : '' }}">
                                        {{ $catName }}
                                    </a>
                                @endforeach
                            </div>
