<x-layout title="Admin - Edit Category | DevSense" description="Edit an existing article category">
                    ...
                    @foreach(['en', 'ru', 'ua', 'bg'] as $loc)
                        ...
                        <div id="tab-{{ $loc }}" class="tab-pane {{ $loop->first ? 'active' : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="translations[{{ $loc }}][name]" id="name_{{ $loc }}" value="{{ old("translations.{$loc}.name", $translation?->name) }}" required placeholder="Category name in {{ $loc }}" class="form-input">
                            </div>
                        </div>
                    @endforeach
                </div>
