---
title: "PHP 8.1: Основни нововъведения и функции | DevSense"
description: "Подробен архитектурен разбор на PHP 8.1: Enums, Readonly Properties, Fibers, Intersection Types, never, First-class Callable Syntax и бележки за миграция."
---

# PHP 8.1: Основни нововъведения

Архитектурен разбор, практични примери и чеклисти за миграция при ъпгрейд от PHP 8.0.x към PHP 8.1.x.
...
PHP 8.1 е “минорен” релийз по номер, но по същество е сериозна стъпка напред в изразителността на езика и консистентността на runtime. Той добавя дълго чакани примитиви като **Enums** и **readonly** properties, подобрява системата от типове (**intersection types**, return type **never**) и въвежда фундаментални runtime building blocks като **Fibers**.
Едновременно с това PHP 8.1 затяга поведението около return types при наследяване, записите в `$GLOBALS`, режимите на грешки във вътрешни разширения (особено MySQLi) и въвежда набор от deprecations, които е добре да изчистите рано, за да са следващите ъпгрейди безболезнени.
