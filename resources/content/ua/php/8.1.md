---
title: "PHP 8.1: Головні нововведення та фічі | DevSense"
description: "Детальний архітектурний розбір PHP 8.1: Enums, Readonly Properties, Fibers, Intersection Types, never, First-class Callable Syntax і нотатки для міграції."
---

# PHP 8.1: Головні нововведення

Архітектурний розбір, практичні приклади та міграційні чеклисти для оновлення з PHP 8.0.x до PHP 8.1.x.
...
PHP 8.1 — “мінорний” реліз за номером версії, але по суті це великий крок уперед у виразності мови та консистентності runtime. Він додає довгоочікувані примітиви на кшталт **Enums** і **readonly** properties, підсилює систему типів (**intersection types**, return type **never**) і вводить фундаментальні runtime building blocks на кшталт **Fibers**.
Паралельно PHP 8.1 робить суворішими правила навколо return types при наслідуванні, записів у `$GLOBALS`, режимів помилок внутрішніх розширень (особливо MySQLi) і вводить набір deprecations, які краще закрити рано, щоб подальші апґрейди проходили без болю.
