...
**Связанные материалы:** [Очереди и брокеры: Redis, RabbitMQ, Kafka](message-queues-compared) · [API gateway и обмен сообщениями](../microservices/api-gateway) · [Sail: очереди и RabbitMQ](../tools/sail-queues)
